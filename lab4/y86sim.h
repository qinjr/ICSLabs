...
typedef struct mem {
    int len;//lenth of this piece of memory
    byte_t *data;//starting addr of the virtual memory
} mem_t;

typedef struct y86sim {
    long_t pc;
    mem_t *r;//a piece of virtual memory to store values of registers
    mem_t *m;//a piece of virtual memory to store all the instructions
    cc_t cc;
} y86sim_t;
